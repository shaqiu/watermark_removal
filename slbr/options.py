...
class Options():
    ...
    def init(self, parser):        
        ...
        parser.add_argument('-c', '--checkpoint', default='checkpoint', type=str, metavar='PATH',
                            help='path to save checkpoint (default: checkpoint)')
        parser.add_argument('--resume', default='D:/task/test/model_best.pth.tar', type=str, metavar='PATH',
        ...
        parser.add_argument('--no_flip',default=True,action='store_true')
        ...
        parser.add_argument('--use_refine', default=True,action='store_true', help='train batchsize')
        ...
        parser.add_argument('--nets', default="slbr", type=str, help='nets')
